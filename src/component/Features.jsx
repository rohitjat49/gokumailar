...
import { FaInbox, FaPaperPlane, FaSyncAlt, FaCode, FaPuzzlePiece, FaRocket } from 'react-icons/fa';

const Features = () => {
  const features = [
    { name: 'Inbox Tester', icon: <FaInbox size={48} />, description: 'Track your campaign performance and see your e-mails are going into Spam or Inbox.' },
    { name: 'Multi Sending', icon: <FaPaperPlane size={48} />, description: 'Send to multiple recipients easily and effectively.' },
    { name: 'Body Rotation', icon: <FaSyncAlt size={48} />, description: 'Rotate the body of emails for better variation.' },
    { name: '5-in-1 Converter', icon: <FaCode size={48} />, description: 'Convert different formats into one consistent format.' },
    { name: 'Unique Syntaxes', icon: <FaPuzzlePiece size={48} />, description: 'Handle unique syntaxes easily with our parser.' },
    { name: 'Fast Server', icon: <FaRocket size={48} />, description: 'Experience fast and reliable server performance.' },
  ];
